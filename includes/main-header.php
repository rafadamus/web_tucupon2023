...
<div class="logo">
	<a href="index.php">
		...
		<!-- <h2>Tienda Virtual rafa</h2> -->

<?php 

$pid=1;
$query=mysqli_query($con,"select img_logo from adm_web where id_web ='$pid'");

while($row=mysqli_fetch_array($query))
{
?>
<img src="/tienda/img_tienda/<?php echo htmlentities($row['img_logo']);?>" width="200" height="100"> 
...
<?php  }   ?>
		...
		<!--  <img src="/tienda/img_tienda/tucupon5.png" border="" height="120px" width="180px"/>  -->
