...
<div class="control-group">
<label class="control-label" for="basicinput">Precio LISTA</label>
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Ingrese precio Lista" class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Precio OFERTA</label>
<div class="controls">
<input type="text"    name="productprice"  placeholder="Ingrese precio OFERTA" class="span8 tip" required>
</div>
</div>


<div class="control-group">
<label class="control-label" for="basicinput">link YOUTUBE</label>
<div class="controls">
<input type="text"    name="productName"  placeholder="Ingrese Link YOUTUBE" class="span8 tip" required>
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Stock CRITICO</label>
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Ingrese Stock CRITICO" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Ingres si prodcto esta ACTIVO" class="span8 tip" required>
</div>
</div>
